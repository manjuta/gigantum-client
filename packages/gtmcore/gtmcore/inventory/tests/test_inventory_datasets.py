...
from gtmcore.dispatcher import dataset_jobs
...
class TestInventoryDatasets(object):
    ...
    def test_delete_dataset(self, mock_config_file):
        ...
        dataset_jobs.clean_dataset_file_cache("test", dataset_delete_job.namespace, dataset_delete_job.name,
    ...
    def test_load_dataset_from_file(self, mock_config_file):
        ...
        with tempfile.TemporaryDirectory() as tempdir:
            ...
            inv_manager.load_dataset_from_directory(r)

        # Test failing case - invalid dir
        with pytest.raises(InventoryException):
            inv_manager.load_dataset_from_directory('/tmp')
